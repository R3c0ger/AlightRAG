...
from alightrag.namespace import NameSpace
from alightrag.operate import (
...
from alightrag.constants import GRAPH_FIELD_SEP
...
from alightrag.types import KnowledgeGraph
...
class AlightRAG:
    ...
    # TODO: Deprecated (AlightRAG will never initialize storage automatically on creation，and finalize should be call before destroying)
    auto_manage_storages_states: bool = field(default=False)
    """If True, alightrag will automatically calls initialize_storages and finalize_storages at the appropriate times."""
    ...
    def __post_init__(self):
        ...
        logger.debug(f"AlightRAG init with param:\n  {_print_config}\n")
    ...
    def _get_storage_class(self, storage_name: str) -> Callable[..., Any]:
        ...
        if storage_name == "JsonKVStorage":
            ...
            from alightrag.kg.nano_vector_db_impl import NanoVectorDBStorage
    ...
    async def adelete_by_entity(self, entity_name: str) -> DeletionResult:
        ...
        Returns:
            DeletionResult: An object containing the outcome of the deletion process.
        """
        from alightrag.utils_graph import adelete_by_entity
    ...
    async def adelete_by_relation(
        ...
        Returns:
            DeletionResult: An object containing the outcome of the deletion process.
        """
        from alightrag.utils_graph import adelete_by_relation
    ...
    async def get_entity_info(
        ...
        from alightrag.utils_graph import get_entity_info
    ...
    async def get_relation_info(
        ...
        from alightrag.utils_graph import get_relation_info
    ...
    async def aedit_entity(
        ...
        """
        from alightrag.utils_graph import aedit_entity
    ...
    async def aedit_relation(
        ...
        """
        from alightrag.utils_graph import aedit_relation
    ...
    async def acreate_entity(
        ...
        """
        from alightrag.utils_graph import acreate_entity
    ...
    async def acreate_relation(
        ...
        """
        from alightrag.utils_graph import acreate_relation
    ...
    async def amerge_entities(
        ...
        """
        from alightrag.utils_graph import amerge_entities
    ...
    async def aexport_data(
        ...
        """
        from alightrag.utils import aexport_data as utils_aexport_data
