#!/usr/bin/env python3
"""
LLM Cache Migration Tool for AlightRAG
...
Usage:
    python -m alightrag.tools.migrate_llm_cache
    # or
    python alightrag/tools/migrate_llm_cache.py
...
class MigrationTool:
    ...
    def print_header(self):
        """Print tool header"""
        print("\n" + "=" * 50)
        print("LLM Cache Migration Tool - AlightRAG")
        print("=" * 50)
