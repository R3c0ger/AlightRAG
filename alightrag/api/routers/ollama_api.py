...
# query mode according to query prefix (bypass is not AlightRAG quer mode)
...
class OllamaAPI:
    def __init__(self, rag: AlightRAG, top_k: int = 60, api_key: Optional[str] = None):
        self.rag = rag
    ...
    def setup_routes(self):
        ...
        async def generate(raw_request: Request):
            ...
            For compatibility purpose, the request is not processed by AlightRAG,
        ...
        async def chat(raw_request: Request):
            ...
            Routes user queries through AlightRAG by selecting query mode based on query prefix.
