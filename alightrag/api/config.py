...
from alightrag.llm.binding_options import (
...
from alightrag.base import OllamaServerInfos
import sys
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="AlightRAG API Server")
    ...
    parser.add_argument(
        ...
        help="API key for authentication. This protects alightrag server against unauthorized access",
    )
    ...
    parser.add_argument(
        ...
        help="Name for the simulated Ollama model (default: from env or alightrag)",
    )
    ...
    args.token_secret = get_env_value("TOKEN_SECRET", "alightrag-jwt-default-secret")
...
def initialize_config(args=None, force=False):
    ...
    which is useful for programmatic usage, testing, or embedding AlightRAG
