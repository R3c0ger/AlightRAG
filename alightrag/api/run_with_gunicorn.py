#!/usr/bin/env python
"""
Start AlightRAG server with Gunicorn
"""
...
from alightrag.api.utils_api import display_splash_screen, check_env_file
from alightrag.api.config import global_args
...
def main():
    ...
    from alightrag.api.config import initialize_config
    ...
    print("🚀 Starting AlightRAG with Gunicorn")
    ...
    class GunicornApp(BaseApplication):
        ...
        def load_config(self):
            ...
            from alightrag.api import gunicorn_config
        ...
        def load(self):
            ...
            from alightrag.api.lightrag_server import get_application
