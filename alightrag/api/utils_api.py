"""
Utility functions for the AlightRAG API.
"""
...
from alightrag.api import __api_version__ as api_version
from alightrag import __version__ as core_version
...
def display_splash_screen(args: argparse.Namespace) -> None:
    """
    Display a colorful splash screen showing AlightRAG server configuration
    ...
    line1_text = f"AlightRAG Server v{core_version}/{api_version}"
