...
from alightrag.api.utils_api import (
...
from alightrag.utils import get_env_value
from alightrag import AlightRAG, __version__ as core_version
from alightrag.api import __api_version__
from alightrag.types import GPTKeywordExtractionFormat
from alightrag.utils import EmbeddingFunc
from alightrag.constants import (
...
from alightrag.api.routers.document_routes import (
    DocumentManager,
    create_document_routes,
)
from alightrag.api.routers.query_routes import create_query_routes
from alightrag.api.routers.graph_routes import create_graph_routes
from alightrag.api.routers.ollama_api import OllamaAPI

from alightrag.utils import logger, set_verbose_debug
from alightrag.kg.shared_storage import (
    get_namespace_data,
...
from alightrag.api.auth import auth_handler

# use the .env that is inside the current folder
# allows to use different .env file for each alightrag instance
...
class LLMConfigCache:
    ...
    def __init__(self, args):
        ...
        if args.llm_binding in ["openai", "azure_openai"]:
            from alightrag.llm.binding_options import OpenAILLMOptions
        ...
        if args.llm_binding == "gemini":
            from alightrag.llm.binding_options import GeminiLLMOptions
        ...
        if args.llm_binding == "ollama":
            try:
                from alightrag.llm.binding_options import OllamaLLMOptions
        ...
        if args.embedding_binding == "ollama":
            try:
                from alightrag.llm.binding_options import OllamaEmbeddingOptions
        ...
        if args.embedding_binding == "gemini":
            try:
                from alightrag.llm.binding_options import GeminiEmbeddingOptions
...
def create_app(args):
    ...
    # Initialize FastAPI
    base_description = (
        "Providing API for AlightRAG core, Web UI and Ollama Model Emulation"
    )
    swagger_description = (
        base_description
    ...
    def create_optimized_azure_openai_llm_func(
        ...
        async def optimized_azure_openai_model_complete(
            ...
            **kwargs,
            ...
            from alightrag.llm.azure_openai import azure_openai_complete_if_cache
    ...
    def create_optimized_gemini_llm_func(
        ...
        async def optimized_gemini_model_complete(
            ...
            **kwargs,
            ...
            from alightrag.llm.gemini import gemini_complete_if_cache
    ...
    def create_llm_model_func(binding: str):
        ...
        try:
            if binding == "lollms":
                from alightrag.llm.lollms import lollms_model_complete

                return lollms_model_complete
            elif binding == "ollama":
                from alightrag.llm.ollama import ollama_model_complete
    ...
    def create_optimized_embedding_function(
        ...
        async def optimized_embedding_function(texts, embedding_dim=None):
            try:
                if binding == "lollms":
                    from alightrag.llm.lollms import lollms_embed

                    return await lollms_embed(
                        texts, embed_model=model, host=host, api_key=api_key
                    )
                elif binding == "ollama":
                    from alightrag.llm.ollama import ollama_embed
                    ...
                    from alightrag.llm.azure_openai import azure_openai_embed

                    return await azure_openai_embed(texts, model=model, api_key=api_key)
                elif binding == "aws_bedrock":
                    from alightrag.llm.bedrock import bedrock_embed

                    return await bedrock_embed(texts, model=model)
                elif binding == "jina":
                    from alightrag.llm.jina import jina_embed
                    ...
                    from alightrag.llm.gemini import gemini_embed
                    ...
                    from alightrag.llm.openai import openai_embed
    ...
    async def bedrock_model_complete(
        ...
        **kwargs,
        ...
        # Lazy import
        from alightrag.llm.bedrock import bedrock_complete_if_cache
    ...
    if args.rerank_binding != "null":
        from alightrag.rerank import cohere_rerank, jina_rerank, ali_rerank
    ...
    from alightrag.api.config import OllamaServerInfos
    ...
    try:
        ...
        logger.error(f"Failed to initialize AlightRAG: {e}")
        raise
    ...
    logging.config.dictConfig(
        {
            ...
            "filters": {
                "path_filter": {
                    "()": "alightrag.utils.LightragPathFilter",
                },
            },
        }
    )
