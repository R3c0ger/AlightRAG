"""
Centralized configuration constants for AlightRAG.

This module defines default values for configuration constants used across
different parts of the AlightRAG system. Centralizing these values ensures
