...
import numpy as np
from alightrag.utils import logger, compute_mdhash_id
...
class MilvusVectorDBStorage(BaseVectorStorage):
    def _create_schema_for_namespace(self) -> CollectionSchema:
        ...
        if self.namespace.endswith("entities"):
            ...
            description = "AlightRAG entities vector storage"
            ...
            description = "AlightRAG relationships vector storage"
            ...
            description = "AlightRAG chunks vector storage"
            ...
            description = "AlightRAG generic vector storage"
