...
from alightrag.exceptions import PipelineNotInitializedError
...
def direct_log(message, enable_output: bool = True, level: str = "DEBUG"):
    ...
    # Get the current logger level from the alightrag logger
    try:
        from alightrag.utils import logger

        current_level = logger.getEffectiveLevel()
    except ImportError:
        # Fallback if alightrag.utils is not available
