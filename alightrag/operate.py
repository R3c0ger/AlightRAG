...
from alightrag.kg.shared_storage import get_storage_keyed_lock
import time
...
async def _build_query_context(
    ...
    # prompt-templated context + detailed/formatted data
    ...
    # combined <prompt-templated context + detailed/formatted data>
