...
logger = logging.getLogger("alightrag")
...
if TYPE_CHECKING:
    from alightrag.base import BaseKVStorage, BaseVectorStorage, QueryParam
...
class LightragPathFilter(logging.Filter):
    """Filter for alightrag logger to filter out frequent path access logs"""
...
def setup_logger(
    ...
    Args:
        ...
        log_file_path: Path to the log file. If None and file logging is enabled, defaults to alightrag.log in LOG_DIR or cwd
...
async def aexport_data(
    ...
    if file_format == "csv":
        ...
        with open(output_path, "w", encoding="utf-8") as mdfile:
            mdfile.write("# AlightRAG Data Export\n\n")
